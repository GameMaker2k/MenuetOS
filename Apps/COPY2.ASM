...
; version:        1.1        ;1.02
; last update:    13/03/2004 ;28/01/2004
; compiler:       FASM 1.51
...
; copying-policy: GPL
    ...
    dd      0x21000        ; memory for app - Must be over 0x20000 - VT
    dd      0x10000        ; esp
...
if lang eq ru
  text:
      db '   ОТКУДА:    |Россия, Ярославль, школа N 56 , 11 А класс     '
      db '    КУДА:     |        Поддубный Иван, ivan-yar@bk.ru         '
      db '                         КОПИРОВАТЬ                           '
  ...
  text:
      db 'SOURCE:       |Russia, Yaroslavl, School N 56 , 11 A class    '
      db 'DESTINATION:  |        Poddubny Ivan, ivan-yar@bk.ru          '
